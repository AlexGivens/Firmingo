...
report={'firmware_sha256':'6cf40edf7438d9b8c173556f14ac0fbee2799f71cc4399c0b31b8f48e0f97d57',
        ...
        'started_utc':time.strftime('%Y-%m-%dT%H:%M:%SZ',time.gmtime()),'status':'failed','attempt':7,'purpose':'packet-captured reproduction of unassisted concurrent condition'}
try:
 ...
 Path('build/application-backend-coexistence-attempt7-captured.json').write_text(json.dumps(report,indent=2)+'\n')
